...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('institutions', function (Blueprint $table) {
            ...
            $table->string('about_detail_text_header', 500)->nullable();
            $table->string('about_detail_text_body', 500)->nullable();
            $table->string('about_detail_text_footer', 500)->nullable();
            $table->string('event_text_footer', 500)->nullable();
            $table->string('event_text_header', 500)->nullable();
            $table->string('services_and_prices_text_header', 500)->nullable();
            $table->string('services_and_prices_text_footer', 500)->nullable();
